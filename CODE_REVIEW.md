...
## Findings
1. This utility overlaps other '*-tools' repos (json-tools, netally-tools, network-tools …); consider consolidating functionality into a modular multi-tool to reduce duplicated scaffolding.
